 ...
 <aside class="main-sidebar">
     ...
     <section class="sidebar">
         ...
         <ul class="sidebar-menu" data-widget="tree">
             ...
             <li><a href="#"><i class="fa fa-users"></i> <span>Data Users</span></a></li>
             <li class="header">ARSIP</li>
             <li><a href="<?php echo base_url('admin/excel') ?>"><i class="fa fa-file-excel-o"></i> <span>File Excel</span></a></li>
         </ul>
     </section>
     <!-- /.sidebar -->
 </aside>